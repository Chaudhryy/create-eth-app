...
2. **Install Yarn:**
   Create Eth App requires Yarn to manage packages. If you haven't installed it, follow these steps:
...
4. **Change into Your App's Directory:**
   Navigate to your new app folder:
   ```sh
   cd my-eth-app
   ```
